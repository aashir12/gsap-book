...
const Footer = () => {
  return (
    <div className="flex items-center justify-between gap-2 px-2 mt-10 border-t-2 border-[#b8ead9] rounded-2xl">
      <div>
        <h6 className="text-[10px] font-bold">UN PREGETTO DI</h6>
        <Image
          src="/logo/logo1.png"
          alt="Logo 1"
          width={80}
      ...
      <div>
        <h6 className="text-[10px] font-bold">CON IL SUPPORTO DI</h6>
        <Image
          src="/logo/logo2.png"
          alt="Logo 2"
          width={80}
      ...
      <div>
        <h6 className="text-[10px] font-bold">DISEGNI E GRAPHICA</h6>
        <div>
      ...
      <div>
        <h6 className="text-[10px] font-bold">ANIMAZIONE</h6>
        <div>
      ...
      <div>
        <h6 className="text-[10px] font-bold">CODICE</h6>
        <div>
